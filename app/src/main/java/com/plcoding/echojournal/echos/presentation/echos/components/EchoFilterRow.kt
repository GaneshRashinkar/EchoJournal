...
fun EchoFilterRow(
    ...
    val dropdownMaxHeight = (configuration.screenHeightDp * 0.3).dp
    FlowRow(
        ...
        MultiChoiceChip(
            ...
            leadingContent = {
                if(moodChipContent.iconRes.isNotEmpty()){
                    Row(
                        ...
                        moodChipContent.iconRes.forEach {
                            iconRes->
                            Image(
            ...
            isClearButtonVisible = hasActiveMoodFilters,
            ...
            dropDownMenu = {
                SelectableDropdownOptionsMenu(
                    ...
                    onItemClick = {
                        moodUi->
                        onAction(EchosAction.OnFilterByMoodClick(moodUi))
                    },
        ...
        MultiChoiceChip(
            ...
            isClearButtonVisible = hasActiveTopicFilters,
            ...
            dropDownMenu = {
                if(topics.isEmpty()){
                    ...
                    SelectableDropdownOptionsMenu(
                        ...
                        key = { topic -> topic },
                        onItemClick = { topic ->
                            onAction(EchosAction.OnFilterByTopicClick(topic))
                        },
                        dropdownOffset = dropdownOffset,
                        maxDropdownHeight = dropdownMaxHeight,
                        leadingIcon = { topic ->
